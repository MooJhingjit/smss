...
export default function ShortcutMenus() {
  ...
  return (
    <div className='grid grid-cols-3 gap-4'>
      <MenuItem
        icon={<KanbanSquare className='w-6 h-6 lg:w-12 lg:h-12  text-white' strokeWidth={1.5} />}
        label="QT Board"
        link="/quotations"
      />
      <MenuItem
        icon={<Receipt className='w-6 h-6 lg:w-12 lg:h-12  text-white' strokeWidth={1.5} />}
        label="POs"
        link="/purchases"
      />
      <MenuItem
        icon={<Box className='w-6 h-6 lg:w-12 lg:h-12  text-white' strokeWidth={1.5} />}
        label="Products"
        link="/products"
      />
      <div className="py-10">
...
const MenuItem = (props: {
  ...
  return (
    <Link
      ...
      <div className='mt-2 text-sm text-gray-100 group-hover:text-white hidden lg:block '>{label}</div>
    </Link>
  )
}
